function continueScalingMovie(configPath, filePath)
...
if ~exist('mode', 'var') || ~strcmpi(mode, 'scaling');
    error('InterPile:WrongFunction', 'Movie is a harmonic dynamics movie. Use continueTimeMovie instead.');
end
...
try
    ...
    assembleMovie(filePath, configPath, movieTime, false, 1, 1, true)
catch ME
