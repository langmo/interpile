...
masks = {...
    {'Ellipsoid', @(y,x,height,width) x.^2/ceil((width)/2).^2+y.^2/ceil((height)/2).^2<1},...
    {'Diamond', @(y,x,height,width) abs(x/ceil(min(width+1, height+1)/2))+abs(y/ceil(min(width+1, height+1)/2))<1},...
